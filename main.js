...
// VERSION 2.0.0 DEV201 Pre-release 1 Hotfix 1
class yaminowplaying {
    constructor(username="Nicezki") {
        ...
        calculateTimeToWait() {
            if (this.data.guestMode == true) {
                console.log("[YAMILISTEN] Guest mode is true, skipping calculate time to wait");
                console.log("[YAMILISTEN] The time to wait is 15 seconds for all friends");
                this.data.reloadTime = 15000;
                console.log("[YAMILISTEN] The rate limit time is 1000ms");
                this.data.limitRateTime = 1000;
                return;
            }
